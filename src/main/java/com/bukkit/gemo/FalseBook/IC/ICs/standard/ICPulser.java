...
public class ICPulser extends BaseIC {
    ...
    public ICPulser() {
        ...
        this.ICDescription = "The ic.pulser fires a (choosable) pulse of high-signals with a choosable length of the signal and the pause between the pulses when the input goes from low to high.<br /><br />Standard is one pulse with a length of 5 ticks.";
    }
    ...
    public class SchedulerClass
        ...
        public SchedulerClass(ICPulser father, Location signLoc, int pulseLength, int pulseCount, int pauseLength) {
            this.father = father;
