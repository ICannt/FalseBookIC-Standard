...
public class ICDelayer extends BaseIC {
    ...
    public ICDelayer() {
        ...
        this.ICDescription = "The ic.delayer delays a high signal for [x] seconds (Line 3), if the signal is stable.";
    }
    ...
    public class SchedulerClass
        ...
        public int TaskID = -1;
        public ICDelayer father;
        public Location signLoc;

        public SchedulerClass(ICDelayer father, Location signLoc) {
            this.father = father;
