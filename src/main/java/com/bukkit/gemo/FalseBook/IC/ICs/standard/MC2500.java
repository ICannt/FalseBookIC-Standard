...
public class MC2500 extends BaseIC
{
  ...
  public MC2500() {
    ...
    this.ICDescription = "The MC2500 fires a (choosable) pulse of high-signals with a choosable length of the signal and the pause between the pulses when the input goes from low to high.<br /><br />Standard is one pulse with a length of 5 ticks.";
  }
    ...
    implements Runnable
  {
    ...
    public SchedulerClass(MC2500 father, Location signLoc, int pulseLength, int pulseCount, int pauseLength) {
      this.father = father;
