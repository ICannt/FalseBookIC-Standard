...
public class ICNotDelayer extends BaseIC {
    ...
    public ICNotDelayer() {
        ...
        this.ICDescription = "The ic.notdelayer delays a high signal for [x] seconds (Line 3) and inverts it, if the signal is stable.";
    }
    ...
    public class SchedulerClass
        ...
        public int TaskID = -1;
        public ICNotDelayer father;
        public Location signLoc;

        public SchedulerClass(ICNotDelayer father, Location signLoc) {
            this.father = father;
