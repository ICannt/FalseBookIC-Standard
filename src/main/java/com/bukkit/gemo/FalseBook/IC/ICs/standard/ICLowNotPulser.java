...
public class ICLowNotPulser extends BaseIC {

    public HashMap<String, SchedulerClass> TaskList = new HashMap<String, SchedulerClass>();

    public ICLowNotPulser() {
        this.ICName = "LOW NOT PULSER";
        this.ICNumber = "ic.lownotpulser";
        ...
        this.ICDescription = "The ic.lownotpulser fires a (choosable) pulse of low-signals with a choosable length of the signal and the pause between the pulses when the input goes from high to low.<br /><br />Standard is one pulse with a length of 5 ticks.";
    }
    ...
    public class SchedulerClass
        ...
        public SchedulerClass(ICLowNotPulser father, Location signLoc, int pulseLength, int pulseCount, int pauseLength) {
            this.father = father;
        ...
        public void run() {
            if (this.first) {
                ICUtils.switchLever(this.signBlock, false);
                this.first = false;
            }
            this.countedTicks += 1;
