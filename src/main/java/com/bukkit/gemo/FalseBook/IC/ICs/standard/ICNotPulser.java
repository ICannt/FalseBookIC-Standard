...
public class ICNotPulser extends BaseIC {

    public HashMap<String, SchedulerClass> TaskList = new HashMap<String, SchedulerClass>();

    public ICNotPulser() {
        this.ICName = "NOT PULSER";
        this.ICNumber = "ic.notpulser";
        ...
        this.ICDescription = "The ic.notpulser fires a (choosable) pulse of low-signals with a choosable length of the signal and the pause between the pulses when the input goes from low to high.<br /><br />Standard is one pulse with a length of 5 ticks.";
    }
    ...
    public class SchedulerClass
        ...
        public SchedulerClass(ICNotPulser father, Location signLoc, int pulseLength, int pulseCount, int pauseLength) {
            this.father = father;
