...
public class ICLowDelayer extends BaseIC {
    ...
    public ICLowDelayer() {
        ...
        this.ICDescription = "The ic.lowdelayer delays a low signal for [x] seconds (Line 3), if the signal is stable.";
    }
    ...
    public class SchedulerClass
        ...
        public int TaskID = -1;
        public ICLowDelayer father;
        public Location signLoc;

        public SchedulerClass(ICLowDelayer father, Location signLoc) {
            this.father = father;
