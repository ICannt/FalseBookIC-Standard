...
public class MC2511 extends BaseIC {
    ...
    public MC2511() {
        ...
        this.ICDescription = "The MC2511 fires a (choosable) pulse of low-signals with a choosable length of the signal and the pause between the pulses when the input goes from high to low.<br /><br />Standard is one pulse with a length of 5 ticks.";
    }
    ...
    public class SchedulerClass
        ...
        public SchedulerClass(MC2511 father, Location signLoc, int pulseLength, int pulseCount, int pauseLength) {
            this.father = father;
