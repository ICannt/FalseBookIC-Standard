...
public class MC2111 extends BaseIC
{
  ...
  public MC2111()
  {
    ...
    this.ICDescription = "The MC2111 delays a low signal for [x] seconds (Line 3) and inverts it, if the signal is stable.";
  }
  ...
  {
    public int TaskID = -1;
    public MC2111 father;
    public Location signLoc;

    public SchedulerClass(MC2111 father, Location signLoc)
    {
      this.father = father;
